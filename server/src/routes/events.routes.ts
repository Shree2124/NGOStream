...
import { createEvent, editEvent, getAllEvents, registerForEvent, getEvent, addEventFeedback,getEventById, generateEventReport, getEventNames } from "../controllers/event.controller";
